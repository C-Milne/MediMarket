...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { address: @seller.address, latitude: @seller.latitude, longitude: @seller.longitude, name: @seller.name } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { address: @seller.address, latitude: @seller.latitude, longitude: @seller.longitude, name: @seller.name } }
